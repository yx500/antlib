                ...
                int& E)
{
  ...
  if ((tip >= 1) && (tip <= 3)) {
    ...
    if (tip == 1)
      OsyCellsPacket = (t_OsyCellsPacket*)GetDatagramData_Func(OsyPacketType, PacketName_1);
    if (tip == 2)
      OsyCellsPacket = (t_OsyCellsPacket*)GetDatagramData_Func(17, PacketName_2);
    if (tip == 3)
      OsyCellsPacket = (t_OsyCellsPacket*)GetDatagramData_Func(17, PacketName_3);
    if (OsyCellsPacket == NULL)
      return false;
                ...
                int& P)
{
  ...
  if (GetDatagramData_Func != NULL)
    KzpCellsPacket = (t_KzpCellsPacket*)GetDatagramData_Func(KzpCellsPacketType, PacketName);
  else
    KzpCellsPacket = NULL;
  if (KzpCellsPacket != NULL) {
