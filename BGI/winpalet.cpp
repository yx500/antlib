...
TDAC DAC[DAC_ARRAYSIZE] = {
    ...
    {    10, 10, 10 , 0  , 63, 63, 63 , 0,  0 ,  6 }, // 10 SV_MIG   „/Ѕел
    {    63, 53, 28 , 0  , 0 , 0 , 0  , 0,  0 ,  0 }, // 11   ∆≈Ћ“џ…
    {    20, 1 , 1  , 0  , 63, 1 , 1  , 0,  0 ,  10}, // 12   COLOR_PSV  –/я –
    ...
    {    20, 50, 20 , 0  , 30, 30, 30 , 0,  0 ,  10}, // 19  зелЄный/серый
    {    0 , 0 , 0  , 0  , 38, 1 , 1  , 0,  0 ,  10}, // 20  красный/черный
    {    38, 1 , 1  , 0  , 63, 63, 63 , 0,  0 ,  10}, // 21  красный/белый
    {    38, 1 , 1  , 0  , 20, 50, 20 , 0,  0 ,  10}, // 22  красный/зелЄный
    {    38, 1 , 1  , 0  , 63, 53, 28 , 0,  0 ,  10}, // 23  красный/желтый
    {    20, 50, 20, 0  , 52, 52 , 52 , 0,  0 ,  10}, // 24  зелЄный/св серый
    {    63, 53, 28, 0  , 52, 52 , 52 , 0,  0 ,  10}, // 25  желтый/св серый
    {    0,  0,  0 , 0  , 32, 32, 32 , 0,  0 ,  6 }, // 26   ‘ќЌ/ „≈–Ќџ…
    {    52, 52 , 52, 0  , 0 , 0 , 0  , 0,  0 ,  6 }, // 27   св серый/„≈–Ќџ…
