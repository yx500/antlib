...
gdp::Brush* _gdp_create_brush(int brsh_cl1 = -1, int brsh_cl2 = -1)
{
    ...
    default                   : break;
    case  EMPTY_FILL          : break;
    case  SOLID_FILL          : pattern = gdp::HatchStyleTotal; break;

    case  LINE_FILL           : pattern = gdp::HatchStyleLightHorizontal; break;
    case  LTSLASH_FILL        : pattern = gdp::HatchStyleLightVertical;  break;
    case  SLASH_FILL          : pattern = gdp::HatchStyleForwardDiagonal; break;
    case  BKSLASH_FILL        : pattern = gdp::HatchStyleBackwardDiagonal; break;
    case  LTBKSLASH_FILL      :
    case  HATCH_FILL          :
    case  XHATCH_FILL         :
    ...
    case  WIDE_DOT_FILL       :
    case  CLOSE_DOT_FILL      :
    case  USER_FILL           : pattern = gdp::HatchStyleSmallCheckerBoard ; break;
    }
...
//> сделать выравнивание строки
        ...
        RECT R; R.left = x; R.top = y; R.right = x + tw; R.bottom = y + th;
...
void PolyColor(int iBrushColor, const TPoint *Points, const int * iColors, const int Points_Count, int PenW)
{
    ...
    if (g.ok()) {
        ...
        for (int i = 1; i < Points_Count; i++) {
            if (iBrushColor == iColors[i-1])  continue;
