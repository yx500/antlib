...
void SetVCLFont(TFont* Font, int nn)
{
    ...
    case 'a': Font->Name = "Arial";
        break;
    case 't': Font->Name = "Times New Roman";
        break;
    case 'c': Font->Name = "Courier New";
        break;
    case 'w': Font->Name = "Wingdings";
        Font->Charset = DEFAULT_CHARSET;
        break;
    case 'v': Font->Name = "Wingdings 2";
        Font->Charset = DEFAULT_CHARSET;
        break;
    case 's': Font->Name = "Wingdings 3";
        Font->Charset = DEFAULT_CHARSET;
        break;
    case 'k': Font->Name = "Webdings";
        Font->Charset = DEFAULT_CHARSET;
        break;
    case 'i': Font->Name = "Terminal";
        Font->Charset = DEFAULT_CHARSET;
        break;
    }
}
...
gdp::Font *_gdp_create_font()
{
    ...
    switch (fontattrib[0]) {
    case 'a': familyName = L"Arial";
        break;
    case 't': familyName = L"Times New Roman";
        break;
    case 'c': familyName = L"Courier New";
        break;
    case 'w': familyName = L"Wingdings";
        break;
    case 'v': familyName = L"Wingdings 2";
        break;
    case 's': familyName = L"Wingdings 3";
        break;
    case 'k': familyName = L"Webdings";
        break;
    case 'i': familyName = L"Terminal";
        break;
    }
    //Font->Charset = RUSSIAN_CHARSET;
    //Font->Charset = DEFAULT_CHARSET;
