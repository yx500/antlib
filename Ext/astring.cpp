...
const wchar_t cp1251[256] =
    {
        ...
        0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445, 0x0446, 0x0447, 0x0448, 0x0449, 0x044A, 0x044B, 0x044C, 0x044D, 0x044E, 0x044F}; // cp1251
...
const wchar_t cp866[256] =
    {
        ...
        0x0401, 0x0451, 0x0404, 0x0454, 0x0407, 0x0457, 0x040E, 0x045E, 0x00B0, 0x2219, 0x00B7, 0x221A, 0x2116, 0x00A4, 0x25A0, 0x00A0}; // cp866

void convert_string866(wchar_t* dst, const char* src, int size)
{
  for (int i = 0; i < size; ++i)
    dst[i] = cp866[(unsigned char)src[i]];
}

void convert_string1251(wchar_t* dst, const char* src, int size)
{
  for (int i = 0; i < size; ++i)
