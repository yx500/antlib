...
private:
  ...
  int busi[Max_Size_Gorl_];
  int marsh_y[Max_Size_Gorl_];
  int marsh_u[Max_Size_Gorl_];
  int itis[Max_Size_Gorl_];
  int clr0[Max_Size_Gorl_];
  int isu[Max_Size_Gorl_];
  int svu[Max_Size_Gorl_];
  int ism[Max_Size_Gorl_];
