...
/*  7654 32107 654 3210
   ...
   ЪДДД ЪД  ЪДДЪДД  ЪДДД
   і    і   і  і    АДДДДДДДДДДДДДД  clr
   і    і   і  АДДДДДДДДДДДДДДДДДДД  is
   і    і   і
   і    і   АДДДДДДДДДДДДДДДДДДДДДД  st3
   і    і
   і    АДДДДДДДДДДДДДДДДДДДДДДДДД   st1
   АДДДДДДДДДДДДДДДДДДДДДДДДДДДДДД   st2  *
