...
void  ShowAUM(const char *name,int x, int y,  int i1,int i1m,int i2,int i2m)
{
    ...
    int d=0;
    int b=0;
    if (strcmp("_ÀÓÌ×1_", name) == 0) {d = 0; p=1;} else
    if (strcmp("_ÀÓÌ×2_", name) == 0) {d = 0; p=2;} else
    if (strcmp("_ÀÓÌ×3_", name) == 0) {d = 0; p=3;} else
    if (strcmp("_ÀÓÌÍ1_", name) == 0) {d = 1; p=1;} else
    if (strcmp("_ÀÓÌÍ2_", name) == 0) {d = 1; p=2;} else
    if (strcmp("_ÀÓÌÍ3_", name) == 0) {d = 1; p=3;} else
    if (strcmp("_ÀÓÌ×1Á_", name) == 0) {b=1;d = 0; p=1;} else
    if (strcmp("_ÀÓÌ×2Á_", name) == 0) {b=1;d = 0; p=2;} else
    if (strcmp("_ÀÓÌ×3Á_", name) == 0) {b=1;d = 0; p=3;} else
    if (strcmp("_ÀÓÌÍ1Á_", name) == 0) {b=1;d = 1; p=1;} else
    if (strcmp("_ÀÓÌÍ2Á_", name) == 0) {b=1;d = 1; p=2;} else
    if (strcmp("_ÀÓÌÍ3Á_", name) == 0) {b=1;d = 1; p=3;}
    int colp=C_D;
    int colb1=FON;
    int colb2=FON;
...
void  SuperLamp2::Show()
{
    ...
    if (MUL_Y < 16) r = 5;
    bool bkpp = false;
    if (strcmp("_ÊÏÏ_", name) == 0) bkpp = true;
    bool bzemlya = false;
    if (strcmp("_ÇÅÌËß_", name) == 0) bzemlya = true;
