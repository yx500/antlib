...
void Lamp:: Set()
{
    ...
    {
        TLampMEM MM;
        memcpy(&MM, &MEM.name16, sizeof(TLampMEM)); // name[16]- �������� �����
...
{
    //int typi;
    //if( !strcmp("��" ,name))  typi = 0;
    //if( !strcmp("���" ,name)) typi  = 1;
    //if( !strcmp("���" ,name)) typi  = 2;
...
void  ShowAUM(const char *name,int x, int y,  int i1,int i1m,int i2,int i2m)
{
    ...
    int d=0;
    int b=0;
    if (strcmp("_����1_", name) == 0) {d = 0; p=1;} else
    if (strcmp("_����2_", name) == 0) {d = 0; p=2;} else
    if (strcmp("_����3_", name) == 0) {d = 0; p=3;} else
    if (strcmp("_����1_", name) == 0) {d = 1; p=1;} else
    if (strcmp("_����2_", name) == 0) {d = 1; p=2;} else
    if (strcmp("_����3_", name) == 0) {d = 1; p=3;} else
    if (strcmp("_����1�_", name) == 0) {b=1;d = 0; p=1;} else
    if (strcmp("_����2�_", name) == 0) {b=1;d = 0; p=2;} else
    if (strcmp("_����3�_", name) == 0) {b=1;d = 0; p=3;} else
    if (strcmp("_����1�_", name) == 0) {b=1;d = 1; p=1;} else
    if (strcmp("_����2�_", name) == 0) {b=1;d = 1; p=2;} else
    if (strcmp("_����3�_", name) == 0) {b=1;d = 1; p=3;}
    int colp=C_D;
    int colb1=FON;
    int colb2=FON;
...
void  SuperLamp2::Show()
{
    ...
    if (MUL_Y < 16) r = 5;
    bool bkpp = false;
    if (strcmp("_���_", name) == 0) bkpp = true;
    bool bzemlya = false;
    if (strcmp("_�����_", name) == 0) bzemlya = true;
