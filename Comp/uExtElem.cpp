...
{
  if ((AL == NULL) || (AL->GrpahExData.Enabled != 1))
    return false;
      ...
      if (AL->LS != NULL) {
        ...
        if (AL->LS->isMyStat4() > 0) {
          ...
          if (GE.PictWidthYch % 2 != 0)
            GE.PictWidthYch++;
          GE.PictHeightYch = GE.PictHeightYch + GE.PictHeightYch / 2;
          if (GE.PictHeightYch % 2 != 0)
            GE.PictHeightYch++;
          GE.PictWidthStan = GE.PictWidthStan + GE.PictWidthStan / 2;
          if (GE.PictWidthStan % 2 != 0)
            GE.PictWidthStan++;
          GE.PictHeightStan = GE.PictHeightStan + GE.PictHeightStan / 2;
        ...
        if (AL->LS->isMyStat3() > 0) {
          ...
          if (GE.PictWidthYch % 2 != 0)
            GE.PictWidthYch++;
          GE.PictHeightYch = GE.PictHeightYch + GE.PictHeightYch / 5;
          if (GE.PictHeightYch % 2 != 0)
            GE.PictHeightYch++;
          GE.PictWidthStan = GE.PictWidthStan + GE.PictWidthStan / 5;
          if (GE.PictWidthStan % 2 != 0)
            GE.PictWidthStan++;
