...
enum STATUS { NET,/*не используется*/
              M,/*мимо */
              P,/*Прямо*/
...
enum TYP {NOTHING, WAY    , PLOT   , SIG_L  , SIG_R  , SWRT   , SWLT   ,
          ...
          NAME   , GORL_L , GORL_R , MESS   , SzT    , SzB    , GORL  ,
          NAPR   , LAMP   , ASN    , KRIV   , OVER   , POIN  , NOMER  ,
          TUPIC  , BL_UH  , LAM4   , STIK   , ELEKTR , PLATF  ,
          ENGL1  , ENGL2  , XBOST1 , XBOST2 , XBOST3 , XBOST4 , KUS1   ,
          KUS2   , P_SVE  , BASH,
          SWrtW   , SWltW   , SWlbW   , SWrbW,
          SUPERLAMP1, SUPERLAMP2, Y_STREL_1, Y_STREL_2, Y_STREL_3, Y_STREL_4,
          LED,
          G_STREL_Y, G_RC, G_ZAMI, G_ZKR, G_STREL_1, G_ZAMP, G_OTCLABEL, G_TPLABEL, G_KZP, G_OSY, G_STREL_2,
          COMMLMP, DTGLMP, LOG_LAMP , VERSION, TRNUM, LINI2, SUBSTATION, LED30, E_OBJ, G_KZP2,Y_STREL_5,Y_STREL_6,G_RC_2
