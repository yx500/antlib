...
void EXD_HideTrainNumber(AComp* AC)
{
  ...
  if (wAC == NULL)
    return;
  // Нужно ли стирать ?
  if (wAC->TrainInfo.TrainNumber == 0)
    return;
...
int GetTNBrushClr(TTrainInfo* TI)
{
  int cl = 0;
  if (TI->TrainColor > 15) {
    if ((TI->TrainNumber >= 1) && (TI->TrainNumber <= 999))
      cl = 207;
    else //красный
      if ((TI->TrainNumber >= 1000) && (TI->TrainNumber <= 4999))
        cl = 236;
      else //синий
        if ((TI->TrainNumber >= 5000) && (TI->TrainNumber <= 5999))
          cl = 251;
        else //желтый
          if ((TI->TrainNumber >= 6000) && (TI->TrainNumber <= 6999))
            cl = 221;
          else //зеленый
            if ((TI->TrainNumber >= 7000) && (TI->TrainNumber <= 8999))
              cl = 251;
            else //желтый
              cl = 246;
  } else {
...
int GetTNPenClr(TTrainInfo* TI)
{
  ...
  if (TI->TrainColor > 15) {
    if ((TI->TrainNumber >= 1) && (TI->TrainNumber <= 999))
      cl = 246;
    else if ((TI->TrainNumber >= 1000) && (TI->TrainNumber <= 4999))
      cl = 246;
    else if ((TI->TrainNumber >= 5000) && (TI->TrainNumber <= 5999))
      cl = 0;
    else if ((TI->TrainNumber >= 6000) && (TI->TrainNumber <= 6999))
      cl = 246;
    else if ((TI->TrainNumber >= 7000) && (TI->TrainNumber <= 8999))
      cl = 0;
    else
      cl = 246;
  } else {
