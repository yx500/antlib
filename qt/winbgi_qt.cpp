...
void drawpoly(int numpoints, const int* intarray)
{
  QPolygon p;
  for (int i = 0; i < numpoints*2; i += 2) {
    p.push_back(QPoint(intarray[i], intarray[i + 1]));
  }
  if (bgi_tracking) {
...
void fillpoly(int numpoints, const int* intarray)
{
  QPolygon p;
  for (int i = 0; i < numpoints*2; i += 2) {
    p.push_back(QPoint(intarray[i], intarray[i + 1]));
