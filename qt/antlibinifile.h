...
class AIniFile : public QSettings {
 public:
  ...
  //  System::TDateTime ReadDate(const String& Section, const String& Name, System::TDateTime
  //  Default); System::TDateTime ReadDateTime(const String& Section, const String& Name,
  //  System::TDateTime Default);
  //  double ReadFloat(const String &Section, const String &Name, double Default);
  //  System::TDateTime ReadTime(const String& Section, const String& Name, System::TDateTime
  //  Default); void WriteBinaryStream(const String& Section, const String& Name, Classes::TStream*
  //  Value); void WriteDate(const String& Section, const String& Name, System::TDateTime Value);
